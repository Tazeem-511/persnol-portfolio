...
const ProjectPage = () => {
  ...
  return (
    <div className="main-project-container grid gap-12 p-4">
      ...
      <div className="projects-container bg-red-700 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <div
          className={`projects major grid grid-cols-1 gap-4 ${
        ...
        <div
          className={`projects mini grid grid-cols-1 gap-4 ${
