...
const ContactPage = () => {
  return (
    <div className=" mt-12 bg-white  mx-auto px-4 py-10">
        ...
        <div className="md:w-1/2">
          ...
          <form className="p-6  rounded-lg ">
            ...
            <div className="mb-4">
              ...
              <textarea
                id="message"
                className="border border-gray-300 p-2 w-full rounded h-32 text-black "
                required
              ></textarea>
            </div>
            <button
              type="submit"
              className="bg-rose-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-300"
            >
              Send Message
            </button>
          </form>
